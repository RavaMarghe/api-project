...
describe("GET /planets/:id", () => {
    ...
    test("Planet does not exist", async () => {
        ...
        expect(response.body.message).toContain("Cannot GET /planets/1");
    });
...
describe("PUT /planets/:id", () => {
    ...
    test("Planet does not exist", async () => {
        ...
        expect(response.body.message).toContain("Cannot PUT /planets/1");
    });
...
describe("DELETE /planets/:id", () => {
    ...
    test("Planet does not exist", async () => {
        ...
        expect(response.body.message).toContain("Cannot DELETE /planets/1");
    });
...
describe("POST /planets/:id/photo ", () => {
    ...
    test("Planet does not exist", async () => {
        ...
        expect(response.body.message).toContain("Cannot POST /planets/1/photo");
    });
